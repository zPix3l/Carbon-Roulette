...
<text x="${cx}" y="370" text-anchor="middle" font-family="Georgia,serif" font-size="86" font-weight="900" letter-spacing="-2">
  <tspan fill="#e8e0d4">Carbon </tspan><tspan fill="url(#gold)" font-style="italic">Roulette</tspan>
</text>
<text x="${cx}" y="416" text-anchor="middle" font-family="monospace" font-size="18" font-weight="700" fill="#c8c8c8" fill-opacity=".35" letter-spacing="8">DUE DILIGENCE GAME</text>
<rect x="${cx-50}" y="446" width="100" height="1" fill="url(#div)"/>
<text x="${cx}" y="500" text-anchor="middle" font-family="Helvetica,Arial,sans-serif" font-size="26" fill="#dcdcdc" fill-opacity=".65">A carbon credit project drops. <tspan fill-opacity=".85" font-weight="500">You decide:</tspan></text>
<text x="${cx}" y="580" text-anchor="middle" font-size="42" font-weight="700">
  ...
  <tspan font-family="Georgia,serif" font-size="30" font-weight="400" font-style="italic" fill="#b4b4b4" fill-opacity=".3" dx="14">or</tspan>
  <tspan font-family="Helvetica,Arial,sans-serif" fill="#a56f73" dx="14">scam</tspan>
...
<text x="${cx+8}" y="${H-46}" text-anchor="middle" font-family="monospace" font-size="16" font-weight="700" fill="#c8c8c8" fill-opacity=".5" letter-spacing="3">YOU HAVE <tspan fill="#fff" fill-opacity=".85">${t}</tspan></text>
</svg>`;
