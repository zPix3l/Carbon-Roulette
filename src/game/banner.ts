...
<g transform="translate(${cx-75},48) scale(.272)">
...
<text x="${cx}" y="266" text-anchor="middle" font-family="Georgia,serif" font-size="50" font-weight="900" letter-spacing="-1">
  <tspan fill="#e8e0d4">Carbon </tspan><tspan fill="url(#gold)" font-style="italic">Roulette</tspan>
</text>
<text x="${cx}" y="298" text-anchor="middle" font-family="monospace" font-size="12" font-weight="700" fill="#c8c8c8" fill-opacity=".35" letter-spacing="5">DUE DILIGENCE GAME</text>
<rect x="${cx-30}" y="322" width="60" height="1" fill="url(#div)"/>
<text x="${cx}" y="362" text-anchor="middle" font-family="Helvetica,Arial,sans-serif" font-size="16" fill="#dcdcdc" fill-opacity=".65">A carbon credit project drops. <tspan fill-opacity=".85" font-weight="500">You decide:</tspan></text>
<text x="${cx}" y="418" text-anchor="middle" font-size="24" font-weight="700">
  <tspan font-family="Helvetica,Arial,sans-serif" fill="#53d077">legit</tspan>
  <tspan font-family="Georgia,serif" font-size="18" font-weight="400" font-style="italic" fill="#b4b4b4" fill-opacity=".3" dx="8">or</tspan>
  <tspan font-family="Helvetica,Arial,sans-serif" fill="#a56f73" dx="8">scam</tspan>
  <tspan fill="#b4b4b4" fill-opacity=".2" font-weight="400" dx="2">?</tspan>
</text>
<line x1="${cx-35}" x2="${cx+35}" y1="425" y2="425" stroke="#53d077" stroke-opacity=".4" stroke-width="2"/>
<line x1="${cx+65}" x2="${cx+123}" y1="425" y2="425" stroke="#a56f73" stroke-opacity=".4" stroke-width="2"/>
<rect x="${cx-130}" y="${H-86}" width="260" height="40" rx="20" fill="#fff" fill-opacity=".03" stroke="#fff" stroke-opacity=".06"/>
<circle cx="${cx-100}" cy="${H-66}" r="4" fill="#53d077"/>
<text x="${cx+5}" y="${H-61}" text-anchor="middle" font-family="monospace" font-size="11" font-weight="700" fill="#c8c8c8" fill-opacity=".5" letter-spacing="2">YOU HAVE <tspan fill="#fff" fill-opacity=".85">${t}</tspan></text>
</svg>`;
